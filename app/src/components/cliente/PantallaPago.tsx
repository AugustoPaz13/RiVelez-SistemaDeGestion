  ...
  const procesarPago = () => {
    ...
    setTimeout(() => {
      ...
      if (exito) {
        ...
        setError('No se pudo confirmar el método de pago. Por favor, intenta con otro método.');
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#1e5d9e' }}>
      ...
      <div style={{ backgroundColor: 'white', borderBottom: '1px solid #e5e7eb', boxShadow: '0 1px 3px 0 rgba(0,0,0,0.1)' }}>
        <div style={{ maxWidth: '1024px', margin: '0 auto', padding: '1rem 1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: '#111827', margin: 0 }}>Realizar Pago</h1>
      ...
      <div style={{ maxWidth: '1024px', margin: '0 auto', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        {/* Mensaje de error */}
        {error && (
          <div style={{ backgroundColor: '#f ee2e2', border: '2px solid #fca5a5', borderRadius: '0.75rem', padding: '1.5rem', display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: seleccionado ? '2px solid #3b82f6' : '2px solid #e5e7eb',
        ...
        {/* Procesando pago */}
        {procesando && (
          <div style={{ backgroundColor: '#eff6ff', borderRadius: '0.75rem', padding: '2rem', textAlign: 'center' }}>
            <div style={{ display: 'inline-block', width: '4rem', height: '4rem', border: '4px solid #3b82f6', borderTopColor: 'transparent', borderRadius: '9999px', animation: 'spin 1s linear infinite', marginBottom: '1rem' }}></div>
            <h3 style={{ color: '#1e40af', marginBottom: '0.5rem', fontSize: '1.25rem', fontWeight: '600' }}>Procesando pago...</h3>
            <p style={{ color: '#3b82f6', margin: 0 }}>Por favor espera un momento</p>
          </div>
        )}
